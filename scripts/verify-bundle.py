...
`models/NOTICE-models.txt` is generated by `convert-ppocr-models.py` rather
...
UNPINNED = {
    "assets/models/NOTICE-models.txt": (
        "generated by scripts/convert-ppocr-models.py from the two model"
    ...
    if problems:
        ...
        if byte_refusals:
            print(
                ...
                " scripts/convert-ppocr-models.py, and rotate a pin only if the"
