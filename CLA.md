...
Thank you for your interest in contributing to UP-TAKE, a project maintained by VyLone ("we", "us").

This Contributor License Agreement ("Agreement") clarifies the terms under which intellectual property
has been contributed to UP-TAKE, so that contributors and users can be confident about the origin and
continued availability of the code.

By submitting a pull request, patch, or other contribution to this repository, you agree to the
...
- You are legally entitled to grant the above license (e.g., it's your original work, or you have
  permission from your employer if it's work-for-hire).
- Your contribution is provided "as is," without warranties of any kind.

## 4. No obligation

This Agreement does not obligate VyLone to use your contribution, and does not create an employment,
